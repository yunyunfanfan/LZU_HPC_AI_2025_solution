"""
使用 DeepSpeed ZeRO-2 进行微调的脚本
基于 finetune.py，添加 DeepSpeed 支持
"""
import os
...
def main():
    parser = argparse.ArgumentParser(description="使用 DeepSpeed ZeRO-2 进行微调")
    ...
    parser.add_argument("--dataset_config", type=str, default="wikitext-2-raw-v1",
                        help="数据集配置")
    parser.add_argument("--output_dir", type=str, default="./optimized_finetune_output/qlora_zero2",
                        help="输出目录")
    ...
    training_args = TrainingArguments(
        ...
        fp16=True,  # DeepSpeed ZeRO-2 需要 FP16
        logging_steps=10,
        save_steps=500,
